...
def compute_average(score, num_students):
    """Computes average score on grade basis, if there are values
    
    Parameters:
        Score (int), # students (int)
    Returns:
        average score (float)
    """
...
def iterate_students_info():
    ...
    return total_score_graded, total_score, student_count, grade_b_count, grade_a_count, score_0_count, score_100_count
...
def summary():
    ...
    total_score_graded, total_score, student_count, grade_b_count, grade_a_count, score_0_count, score_100_count = iterate_students_info()
    
    graded_count = grade_a_count + grade_b_count
    total_average = compute_average(total_score, student_count)
    graded_average = compute_average(total_score_graded, graded_count)
