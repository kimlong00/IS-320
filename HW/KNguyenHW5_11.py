...
def prices():
    ...
    if new_premium:
        ...
        if not is_valid_gas_price(new_premium):
            print('Invalid Input: Please enter a positive value greater than 0!')
            return
