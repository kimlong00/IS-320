...
def save():
    """Save/Write data to output file
    ...
    global students_grade
    with open('G:\My Drive\IS 320\HW\hw_score_outputs.txt', 'w') as outfile:

        for students in students_grades.keys():
            value = students_grades[students]
            outfile.write(convert_to_csv(value) + '\n')
